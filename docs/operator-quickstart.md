# Operator Quickstart — cloud-itonami-isic-3822

Shortest path from clone to a verified local dry-run for **ISIC 3822** (`cloud-itonami-isic-3822`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3822.git
